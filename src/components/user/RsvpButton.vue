    ...
    <div v-if="$isUserLoggedIn">
      <div v-if="rsvp_check_loading">
        ...
        >
          ...
          <span class="dark:text-verse-700 text-green-600 uppercase"
            >loading...</span
          >
        </div>
      </div>
      <div v-else>
        <Transition mode="out-in" name="fade">
          <div v-if="rsvp_is_attending">
            <!-- Attending -->
            <rsvp-booking-confirmed
              @open="$emit('open')"
              @cancel-rsvp="unRsvpToMeetup()"
          ...
          <div v-else>
            ...
            >
              ...
              <span class="dark:text-slate-900 text-verse-100"
                >Book my seat</span
              >
            </button>
          </div>
