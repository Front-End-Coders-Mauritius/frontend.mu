...
function extractValues(profile) {
  return {
    ...profile,
    meal: profile.meal.value || "",
    transport: profile.transport.value || "",
    current_occupation: profile.current_occupation.value || "",
  };
}

const updateProfile = () => {
  updateUserProfile(profile.value).then((data) => {
    profile.value = data;
    ...
    <Transition>
      ...
      <div class="divide-y divide-white/5 dark:text-white" v-else>
        <template v-if="$isUserLoggedIn">
          <div
            class="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-3"
          >
            <div>
              ...
              <p
                class="mt-1 text-lg leading-6 text-verse-500 dark:text-verse-200"
              >
            ...
            <form class="md:col-span-2 pb-16">
              ...
              >
                ...
                <div class="col-span-full">
                  <label for="email" class="block text-lg font-medium leading-6"
                    >Email address</label
                  >
                  <div class="mt-2">
                    <input
                ...
                <div class="col-span-full">
                  <label for="phone" class="block text-lg font-medium leading-6"
                    >Phone</label
                  >
                  <div class="mt-2">
                    <div
          ...
          <div
            class="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 py-16 md:grid-cols-3"
          >
            <div>
