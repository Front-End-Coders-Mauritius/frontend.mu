...
<template>
  <a
    class="ml-4 flex px-3 py-2 text-sm font-medium rounded-full shadow-lg bg-white/90 shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10 whitespace-nowrap"
    v-if="!$isUserLoggedIn"
    href="/login"
  >
    Log In
