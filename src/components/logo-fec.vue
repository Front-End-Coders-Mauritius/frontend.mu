  ...
  <div :class="[{ 'spin': !!loading }]">
    <svg width="100%" viewBox="0 0 1106 1031" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path fill-rule="evenodd" clip-rule="evenodd"
        d="M482.465 254.049H573.133L460.931 518.435L460.907 518.492L358.953 760.966H268.312L482.465 254.049ZM626.002 308.04L837.787 519.878L455.608 711.855L504.574 595.196L702.487 501.5L591.465 388.902L626.002 308.04Z"
        fill="currentColor" />
    </svg>
  </div>
</template>
