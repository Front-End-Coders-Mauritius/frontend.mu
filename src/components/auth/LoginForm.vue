...
<template>
  <div class="sm:mx-auto sm:w-full sm:max-w-md">
    ...
    <h2
      class="mt-6 text-center text-2xl font-bold leading-9 tracking-tight text-verse-900 dark:text-verse-100"
    >
      ...
      <div v-else>
        ...
        <div v-else>
          <div class="relative">
            ...
            >
              <span class="bg-white px-6 text-gray-900">Continue with</span>
            </div>
          </div>
