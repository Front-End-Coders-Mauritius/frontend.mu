...
<template>
    <button @click="toggleDark()" class="toggle-button bg-brand-100">
        <svg width="724" height="724" viewBox="0 0 724 724" fill="#fff" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" v-if="isDark">
            <path
        ...
        <svg width="681" height="681" viewBox="0 0 681 681" fill="#fff" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" v-else>
            <path
...
.toggle-button:hover {
    ...
    box-shadow: 0 0 15px var(--yellow-sun);
    text-shadow: 0 0 15px var(--yellow-sun);
}
...
body[color-scheme="dark"] .toggle-button {
    background-color: #171515;
}
body[color-scheme="dark"] .toggle-button:hover {
    color: var(--whitegray);
    box-shadow: 0 0 15px var(--whitegray);
    text-shadow: 0 0 15px var(--whitegray);
}
body[color-scheme="dark"] .toggle-button:hover svg {
    transition: 0.5s;
    fill: var(--yellow-sun);
}
body[color-scheme="dark"] .toggle-button:hover svg {
...
body[color-scheme="dark"] .toggle-button:hover::before {
    box-shadow: 0 0 15px var(--whitegray);
}
</style>