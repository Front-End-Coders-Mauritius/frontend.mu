...
<template>
  <div class="flex justify-center items-center">
            ...
            <TransitionChild as="template" enter="ease-out duration-300"
              ...
              <DialogPanel
                ...
                <div data-mobile :class="!rsvp_is_attending ? 'grid-cols-[auto_1fr]' : 'grid-cols-1'"
                  ...
                  <div class="grid">
                    <dl :class="{ 'grid-rows-[auto_1fr_auto]': rsvp_is_attending }"
                        ...
                        <div v-if="!rsvp_is_attending" class="grid grid-rows-[1fr_auto] items-center gap-6 h-full pr-1">
                          ...
                          <div class="grid justify-center h-20 w-full">
                            <div class="join gap-2">
                              <button class="btn join-item" @click="goToPrevStep">
                                <IconUp />
                              </button>
                              <button class="btn join-item" @click="goToNextStep">
                                <IconDown></IconDown>
                              </button>
                            </div>
                          </div>
    ...
    <RsvpButton :rsvp_check_loading="rsvp_check_loading" :rsvp_is_attending="rsvp_is_attending" :profile="profile"
      :rsvp_loading="rsvp_loading" :unRsvpToMeetup="unRsvpToMeetup" :oAuthLogin="oAuthLogin" @open="open = true" />
  </div>
</template>
